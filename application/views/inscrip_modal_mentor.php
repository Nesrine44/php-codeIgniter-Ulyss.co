...
<div class="modal fade text-center modal_home" id="modalInscriptionMentor" role="dialog">
            ...
            <div class="modal-body">
                        ...
                        <div class="row mgb_0">
                            <div class="col-md-12 conex_fb">
                                <form action="/auth/linkedinConnect" method="get" name="loginlinkedin">
                                    <input type="hidden" name="callback" value="inscription/insider"/>
                ...
                <div class="row">
                    <div class="col-md-10 col-md-offset-1">
                        ...
                        <a href="<?php echo base_url() ?>inscription/insider"><input type="button" value="M'inscrire avec mon e-mail"></a>
                    </div>
                </div>
                <hr>
