...
<section class="pg-ccm pg-dcc">
    <div class="container">
        <form action="<?php echo base_url(); ?>mentor/add" method="POST" enctype="multipart/form-data" name="f_postmentor4">
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-12">
                ...
                <p class="text-chk"> Partagez notre page pour que chacun puisse trouver un Insider dans son domaine! </p>
            </div>
        </div>
