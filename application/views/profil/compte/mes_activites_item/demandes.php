			...
			<div class="col-md-9 block_activ_demande">
				<div class="row nav_comment">
					<ul class="col-md-12 mg_15">
						<li class="active"><a href="<?php echo base_url(); ?>mes_activites/demandes">En cours</a></li>
						<li><a href="<?php echo base_url(); ?>mes_activites/historiques_des_prestations_demande">Historique des prestations</a></li>
					</ul>
				</div>
