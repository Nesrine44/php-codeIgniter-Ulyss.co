...
<table class="wrapper_table" style="width: 500px; max-width: 500px;background: #04a0e4;    border-radius: 10px 10px 0 0;" border="0" cellpadding="0" cellspacing="0" align="center">
	<tbody align="center">
		<tr height="40"></tr>
		<tr style="color:#fff;font-size: 28px;font-weight: lighter;"><td><?php echo $label; ?></td></tr>
		<tr height="40"></tr>
	</tbody>
</table>
...
<table class="wrapper_table" style="width: 500px; max-width: 500px;background: #fff;" border="0" cellpadding="0" cellspacing="0" align="center">
	<tbody align="center">
	<tr height="30"></tr>
	<tr><?php echo $content; ?><br>LՎquipe <?php echo $this->lang->line("title_site"); ?></td></tr>
	<tr height="40"></tr>
	</tbody>
</table>
<table class="wrapper_table" style="width: 500px; max-width: 500px;background: none;" border="0" cellpadding="0" cellspacing="0" align="center">
	<tbody align="center">
		<tr height="15"></tr>
		<tr style="color:#000;font-size: 14px;font-weight: 300;"><td>Copyright <?php echo $this->lang->line("title_site"); ?> - <?php echo date("Y"); ?></td></tr>
		<tr height="15"></tr>
	</tbody>
</table>
</body>
